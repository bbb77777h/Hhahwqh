...
BOT_TOKEN = "7868379268:AAHdM_FjT7X1zvxW791Tib_Y0_YPlzJMATA"
CHANNEL_ID = ["-1002389821535", "-1002214653492"]
OWNER_ID = {5730843286, 6659804884}  # Replace with your owner IDs
...
async def start(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if not await is_user_in_all_channels(user_id, context):
        await update.message.reply_text(
            ...
            "1. [Channel 1](https://t.me/+Z3X35JW70ahhM2Q1)\n"
            "2. [Channel 2](https://t.me/+77OkjGOfoOwzNjE)",
            parse_mode="Markdown",
        )
    else:
...
async def bgmi(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    try:
        subprocess.Popen(["./bgmi", ip, str(port), str(time_sec), thread])
